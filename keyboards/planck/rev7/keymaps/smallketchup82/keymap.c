...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_planck_grid(
        ...
        RGB_TOG, KC_LCTL, KC_LALT, KC_LGUI, TT(_SYMBOLS), KC_SPC, KC_SPC, TT(_NUMBERS), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
        ),
	[_SYMBOLS] = LAYOUT_planck_grid(
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,        KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
        KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,         KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
        KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,        KC_F11,  KC_F12,  KC_TRNS, KC_MPLY, KC_TRNS, KC_ENTER, KC_TRNS,
	...
	[_SETTINGS] = LAYOUT_planck_grid(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC,  KC_SPC,  KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
        )
};
